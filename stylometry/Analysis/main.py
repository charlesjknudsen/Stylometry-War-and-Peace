...
def Analysis(vector, colorArrangement, K=2):
	...
	plt.title(title)
	plt.savefig("MAUDEvVOLOKHONSKY" + ".png")
	plt.show()
...
if __name__ == '__main__':
	...
	for document in documents:
		vector += FeatureExtration(open(document, encoding="utf8").read(), winSize=50, step=50) #change to 50/10 (winsize, step)
		vectorList.append(FeatureExtration(open(document, encoding="utf8").read(), winSize=50, step=50)) #change to 50/10 (winsize, step)
